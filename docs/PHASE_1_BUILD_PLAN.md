...
**Repository:** sn_csa_exam_drift_detector
...
Build a production-ready ServiceNow scoped application that monitors and detects drift between a servicenow instance configuration and the csa (certified system administrator) exam blueprint, highlighting practice areas for certification prep.. The application must be installable on any Australia-era ServiceNow instance and must pass automated functional tests with zero external runtime dependencies.
